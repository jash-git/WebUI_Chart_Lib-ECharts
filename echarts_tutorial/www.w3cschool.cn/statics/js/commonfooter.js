...
function loadvip(){
	...
	'<div class="vip-main">'+
		...
		'<a href="/vip"><img src="//7nsts.w3cschool.cn/images/w3c/vip-dialog.png?t=1206"  alt="升级为VIP，尊享更多特权" class="vip-dialog"/></a>'+
	'</div>'+
'</div>';
				...
				if(arr.statusCode == '200' && typeof info.username != 'undefined'){
					...
					if((timestamp-_widgetCookie) >= 86400000){
						...
						if(typeof dict != 'undefined'){
							...
							var widget = '';
							if(type == 'index'){
								widget = widget + '<div class="widget-main" data-type="index" style="display: none;"><div class="widget-box"><div class="slogn"><a href="/register">免费注册w3cschool，收藏您感兴趣的教程手册！</a></div><div class="quicklogin quick-box">'
	            ...
	            if(typeof check != 'undefined'){
	                if(arr.statusCode == '200' && typeof info.username != 'undefined'){
	                    ...
	                    html += '<span>学号：'+info.uid+'</span></div></div><div class="user-desc"><span>等级：LV'+info.level+'</span>'
	                            ...
	                            html += '</ul></div><a href="/vip" target="_blank" class="vipclub-btn">会员中心 »</a></div>';
	                    $('.quick-item').remove();
